 ...
 * \ingroup aodvetx
 *
 * \brief AODVETX loopback UDP echo test case
 */
 ...
 *
 * \brief AODVETX Loopback test suite
 */
class AodvEtxLoopbackTestSuite : public TestSuite
{
  public:
    AodvEtxLoopbackTestSuite()
        : TestSuite("routing-aodvetx-loopback", Type::SYSTEM)
    {
        SetDataDir(NS_TEST_SOURCEDIR);
        // UDP Echo loopback test case
        AddTestCase(new LoopbackTestCase(), TestCase::Duration::QUICK);
    }
} g_aodvetxLoopbackTestSuite; ///< the test suite
