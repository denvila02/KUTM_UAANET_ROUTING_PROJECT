 ...
 */
#ifndef AODVETXPACKET_H
#define AODVETXPACKET_H
...
enum MessageType
{
    AODVETXTYPE_RREQ = 1,    //!< AODVETXTYPE_RREQ
    AODVETXTYPE_RREP = 2,    //!< AODVETXTYPE_RREP
    AODVETXTYPE_RERR = 3,    //!< AODVETXTYPE_RERR
    AODVETXTYPE_RREP_ACK = 4, //!< AODVETXTYPE_RREP_ACK
    AODVETXTYPE_LPP=5
};
...
class TypeHeader : public Header
{
  public:
    /**
     * constructor
     * \param t the AODVETX RREQ type
     */
    TypeHeader(MessageType t = AODVETXTYPE_RREQ);
...
public:
  ...
  {
    return static_cast<uint16_t> (m_neighborsLppCnt.size ());
  }
...
std::ostream & operator<< (std::ostream & os, LppHeader const & h);

} // namespace aodvetx
} // namespace ns3


#endif /* AODVETXPACKET_H */
