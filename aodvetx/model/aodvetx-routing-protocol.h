 ...
 */
#ifndef AODVETXROUTINGPROTOCOL_H
#define AODVETXROUTINGPROTOCOL_H
 ...
 * \ingroup aodvetx
 *
 * \brief AODVETX routing protocol
 */
class RoutingProtocol : public Ipv4RoutingProtocol
{
  public:
    ...
    static const uint32_t AODVETX_PORT;
  ...
  private:
     ...
     */
    void RecvAodvEtx(Ptr<Socket> socket);
    /**
     * Receive RREQ
     * \param p packet
    ...
    void RecvLpp(Ptr<Packet>p, Ipv4Address reciever, Ipv4Address src);
    void SendLpp();
...
#endif /* AODVETXROUTINGPROTOCOL_H */
