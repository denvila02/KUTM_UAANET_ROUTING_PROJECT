 ...
 */
#ifndef AODVETX_RQUEUE_H
#define AODVETX_RQUEUE_H
...
/**
 * \ingroup aodvetx
 * \brief AODVETX route request queue
 *
 * Since AODVETX is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
