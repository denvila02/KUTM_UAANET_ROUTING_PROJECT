 ...
 */
#ifndef QSPU_RQUEUE_H
#define QSPU_RQUEUE_H
...
/**
 * \ingroup qspu
 * \brief QSPU route request queue
 *
 * Since QSPU is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
