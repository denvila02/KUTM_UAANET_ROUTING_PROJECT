 ...
 */
#ifndef QSPU_RTABLE_H
#define QSPU_RTABLE_H
...
class RoutingTableEntry
{
  public:
    ...
    void SetQspuConnectivity10000 (uint32_t co)
{
  m_qspuConnectivity10000 = co;
}

uint32_t GetQspuConnectivity10000 () const
{
  return m_qspuConnectivity10000;
}

void SetQspuLifetime (Time lifetime)
{
  m_qspuLifetime = lifetime;
}

Time GetQspuLifetime () const
{
  return m_qspuLifetime;
}

void SetQspuDelay (Time delay)
{
  m_qspuDelay = delay;
}

Time GetQspuDelay () const
{
  return m_qspuDelay;
}

void SetQspuCost10000 (uint32_t cost)
{
  m_qspuCost10000 = cost;
}

uint32_t GetQspuCost10000 () const
{
  return m_qspuCost10000;
}

void SetQspuRoute (bool q)
{
  m_qspuRoute = q;
}

bool IsQspuRoute () const
{
  return m_qspuRoute;
}
  ...
  private:
    ...
    uint32_t m_qspuConnectivity10000;
    Time m_qspuLifetime;
    Time m_qspuDelay;
    uint32_t m_qspuCost10000;
    bool m_qspuRoute;
...
/**
 * \ingroup qspu
 * \brief The Routing table used by QSPU protocol
 */
class RoutingTable
{
  public:
