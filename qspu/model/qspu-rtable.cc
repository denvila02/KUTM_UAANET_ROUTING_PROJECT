...
NS_LOG_COMPONENT_DEFINE("QspuRoutingTable");
...
RoutingTableEntry::RoutingTableEntry(Ptr<NetDevice> dev,
    ...
    : m_ackTimer(Timer::CANCEL_ON_DESTROY),
      ...
      m_qspuConnectivity10000 (0),
m_qspuLifetime (Seconds (0)),
m_qspuDelay (Seconds (0)),
m_qspuCost10000 (std::numeric_limits<uint32_t>::max ()),
m_qspuRoute (false)
{
