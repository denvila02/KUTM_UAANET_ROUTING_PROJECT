 ...
 * \ingroup qspu
 *
 * \brief QSPU loopback UDP echo test case
 */
 ...
 * \ingroup qspu-test
 *
 * \brief QSPU Loopback test suite
 */
class QspuLoopbackTestSuite : public TestSuite
{
  public:
    QspuLoopbackTestSuite()
        : TestSuite("routing-qspu-loopback", Type::SYSTEM)
    {
        SetDataDir(NS_TEST_SOURCEDIR);
        // UDP Echo loopback test case
        AddTestCase(new LoopbackTestCase(), TestCase::Duration::QUICK);
    }
} g_qspuLoopbackTestSuite; ///< the test suite
